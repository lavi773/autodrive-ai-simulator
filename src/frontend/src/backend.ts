...
export class Backend implements backendInterface {
    ...
    async getDecisionLog(): Promise<Array<DecisionEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDecisionLog();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async makeDecision(arg0: number, arg1: number, arg2: string, arg3: boolean): Promise<{
        action: string;
        reason: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.makeDecision(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetLog(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetLog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
